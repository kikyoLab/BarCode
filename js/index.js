                ...
                function addRow () {
                    ...
                    if (prototypeText.length !== 0) {
                        for (var i = 0; i < newText.length; i++) {
                            ...
                            dragEvent("text" + randomNum, { minSize: 35 });
                            randomNum--
                        }
                    }
                    ...
                    if (prototypeLine.length !== 0) {
                        for (var i = 0; i < newLine.length; i++) {
                            ...
                            dragEvent("lineDiv" + randomNum, { minSize: 3 });
                            randomNum--
                        }
                    }
                    ...
                    if (prototypeBarCode.length !== 0) {
                        ...
                        for (var i = 0; i < newBarCode.length; i++) {
                            ...
                            dragEvent("Code" + randomNum, { minSize: 52 });
                            randomNum--
                        }
                    }
                    ...
                    if (prototypeQarCode.length !== 0) {
                        for (let i = 0; i < newQarCode.length; i++) {
                            ...
                            dragEvent("QrCode" + randomNum, { minSize: 30 });
                            randomNum--
                        }
                    }
                }
                ...
                function addColumn () {
                    ...
                    if (prototypeText.length !== 0) {
                        for (var i = 0; i < newcolumnText.length; i++) {
                            ...
                            dragEvent("text" + columnRandomNum, { minSize: 35 });
                            columnRandomNum--
                        }
                    }
                    ...
                    if (prototypeLine.length !== 0) {
                        for (var i = 0; i < newcolumnLine.length; i++) {
                            ...
                            dragEvent("lineDiv" + columnRandomNum, { minSize: 3 });
                            columnRandomNum--
                        }
                    }
                    ...
                    if (prototypeBarCode.length !== 0) {
                        for (var i = 0; i < newcolumnBarCode.length; i++) {
                            ...
                            dragEvent("Code" + columnRandomNum, { minSize: 52 });
                            columnRandomNum--
                        }
                    }
                    ...
                    if (prototypeQarCode.length !== 0) {
                        for (var i = 0; i < newcolumnQarCode.length; i++) {
                            ...
                            dragEvent("QrCode" + columnRandomNum, { minSize: 30 });
                            columnRandomNum--
                        }
                    }
                }
        ...
        $("#" + j).click(function () {
            ...
            for (let l = 0; l < b.allNum; l++) {
                ...
                if (document.getElementById("QrCode" + l)) {
                    ...
                    dragEvent("QrCode" + l, { minSize: 30 });
                }

                if (document.getElementById("lineDiv" + l)) {
                    console.log('line++')
                    dragEvent("lineDiv" + l, { minSize: 2 });
                }

                if (document.getElementById("boxDiv" + l)) {
                    console.log('box++')
                    dragEvent("boxDiv" + l, { minSize: 30 });
                }
            }
...
function dragEvent (ele, config = {}) {
    ...
    injectDragger(document.getElementById(ele), config)
}