...
$(function () {
    $multPrint.click(function () {
        ...
        for (var i = 0; i < pageText.length; i++) {
            ...
            console.log(`${pageText[i].dataset.text}:${dataValueList[0][pageText[i].dataset.text]}`)
        }
        ...
        for (var i = 1; i < dataList.length; i++) {
            ...
            for (var j = 0; j < newText.length; j++) {
                ...
                console.log(`第${j}个文本框 => ${newText[j].dataset.text}:${pullDataValue[newText[j].dataset.text]}`)
            }
        }
